...
export default {
  ...
  methods: {
    ...
    async fetchCategories() {
      try {
        const response = await axios.get('http://vasyaproger-backend1-c0b9.twc1.net/api/categories/');
    ...
    async fetchSuggestions(query) {
      ...
      try {
        const response = await axios.get(`http://vasyaproger-backend1-c0b9.twc1.net/api/products/?search=${query}`);
    ...
    getImageUrl(image) {
      ...
      return image.startsWith('http') ? image : `http://vasyaproger-backend1-c0b9.twc1.net:8000${image}`;
    },
    ...
    async submitOrder() {
      ...
      try {
        await axios.post('http://vasyaproger-backend1-c0b9.twc1.net:8000/api/orders/', orderData);
